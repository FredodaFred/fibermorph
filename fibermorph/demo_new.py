...
class Demo(Fibermorph):
    ...
    def real_curv(self, path):
        ...
        curv = Curvature()
        curv.curvature_seq(input_directory.__str__(), output_dir.__str__(), resolution=132, window_size=0.5, window_unit="mm", save_img=True, within_element=False, fiblog = fiblog)
